    ...
    <div className="flex flex-col min-h-screen bg-[#F8F9FA] font-sans pb-16">
      ...
      <section className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8 mt-4">
         ...
         <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
             {/* Example Room 1 */}
             <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden group hover:shadow-xl transition-shadow duration-300">
                 <div className="relative h-56 overflow-hidden">
                     <div className="absolute top-4 left-4 z-10 flex gap-2">
                        <span className="bg-white/95 backdrop-blur-md text-[11px] font-bold px-2.5 py-1 rounded-full text-slate-700 shadow-sm">TẦNG 01</span>
                        <span className="bg-[#22A06B] text-white text-[11px] font-bold px-2.5 py-1 rounded-full shadow-sm">TRỐNG</span>
                     </div>
                     <img src="https://images.unsplash.com/photo-1554995207-c18c203602cb?auto=format&fit=crop&w=800&q=80" alt="Room" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                 </div>
                 <div className="p-6">
                    <div className="flex justify-between items-start mb-3">
                        <div>
                            <h3 className="text-[18px] font-bold text-[#0F172A] leading-tight">Luxury Studio A1</h3>
                            <p className="text-[#64748B] text-[13px] mt-1 font-medium">Mã: DC-A101</p>
                        </div>
                        <div className="text-right">
                           <div className="text-[18px] font-extrabold text-[#0052CC]">3.500.000đ</div>
                           <div className="text-[11px] font-semibold text-[#94A3B8] uppercase">mỗi tháng</div>
                        </div>
                    </div>
                    <div className="flex gap-4 mt-5 text-[13px] text-[#475569] font-medium border-t border-slate-100 pt-5">
                        <div className="flex items-center gap-1.5 bg-[#F8F9FA] px-2.5 py-1.5 rounded-lg">
                        ...
                        <div className="flex items-center gap-1.5 bg-[#F8F9FA] px-2.5 py-1.5 rounded-lg">
                           <svg className="w-4 h-4 text-[#94A3B8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" /></svg>
                           Ban công
                        </div>
                    </div>
                    <div className="mt-6 flex gap-3">
                        ...
                        <button className="bg-[#F1F5F9] text-[#64748B] p-3 rounded-xl hover:bg-[#E2E8F0] transition-colors">
             ...
             <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden group hover:shadow-xl transition-shadow duration-300">
                 <div className="relative h-56 overflow-hidden">
                     <div className="absolute top-4 left-4 z-10 flex gap-2">
                        <span className="bg-white/95 backdrop-blur-md text-[11px] font-bold px-2.5 py-1 rounded-full text-slate-700 shadow-sm">TẦNG 02</span>
                        <span className="bg-[#0052CC] text-white text-[11px] font-bold px-2.5 py-1 rounded-full shadow-sm">ĐẾN SỚM</span>
                     </div>
                     <img src="https://images.unsplash.com/photo-1540518614846-7eded433c457?auto=format&fit=crop&w=800&q=80" alt="Room" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                 </div>
                 <div className="p-6">
                    <div className="flex justify-between items-start mb-3">
                        <div>
                            <h3 className="text-[18px] font-bold text-[#0F172A] leading-tight">Standard B4</h3>
                            <p className="text-[#64748B] text-[13px] mt-1 font-medium">Mã: DC-S034</p>
                        </div>
                        <div className="text-right">
                           <div className="text-[18px] font-extrabold text-[#0052CC]">2.200.000đ</div>
                           <div className="text-[11px] font-semibold text-[#94A3B8] uppercase">mỗi tháng</div>
                        </div>
                    </div>
                    <div className="flex gap-4 mt-5 text-[13px] text-[#475569] font-medium border-t border-slate-100 pt-5">
             ...
             <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden group hover:shadow-xl transition-shadow duration-300">
                 <div className="relative h-56 overflow-hidden">
                     <div className="absolute top-4 left-4 z-10 flex gap-2">
                        <span className="bg-white/95 backdrop-blur-md text-[11px] font-bold px-2.5 py-1 rounded-full text-slate-700 shadow-sm">TẦNG 01</span>
                        <span className="bg-[#0F172A] text-white text-[11px] font-bold px-2.5 py-1 rounded-full shadow-sm">VIP</span>
                     </div>
                     <img src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=800&q=80" alt="Room" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                 </div>
                 <div className="p-6">
                    <div className="flex justify-between items-start mb-3">
                        <div>
                            <h3 className="text-[18px] font-bold text-[#0F172A] leading-tight">Premier Suite C1</h3>
                            <p className="text-[#64748B] text-[13px] mt-1 font-medium">Mã: DC-C101</p>
                        </div>
                        <div className="text-right">
                           <div className="text-[18px] font-extrabold text-[#0052CC]">4.800.000đ</div>
                           <div className="text-[11px] font-semibold text-[#94A3B8] uppercase">mỗi tháng</div>
                        </div>
                    </div>
                    <div className="flex gap-4 mt-5 text-[13px] text-[#475569] font-medium border-t border-slate-100 pt-5">
