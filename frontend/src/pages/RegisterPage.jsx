    ...
    <div className="w-full flex flex-col justify-between">
        ...
        <div className="max-w-6xl w-full grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-24">
          ...
          <div className="pt-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-[0_4px_25px_rgb(0,0,0,0.03)] mb-8 space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#64748B] text-[13px] leading-relaxed pr-2">
                    Dữ liệu của bạn được mã hóa chuẩn quân đội (AES-256) và chỉ sử dụng cho mục đích xác thực danh tính
                    cư dân theo quy định pháp luật.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#64748B] text-[13px] leading-relaxed pr-2">
                    Chúng tôi yêu cầu CCCD để hoàn tất thủ tục đăng ký tạm trú bắt buộc và đảm bảo môi trường sống an
                    toàn, không có đối tượng giả danh trong khu lưu trú.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 text-[14px] font-bold">
              ...
              <div className="flex items-center gap-3">
                <span className="w-8 h-8 rounded-full bg-[#E2E8F0] text-[#64748B] flex items-center justify-center">
                  2
                </span>
            ...
            <div className="bg-white rounded-[32px] p-8 md:p-10 shadow-[0_4px_30px_rgb(0,0,0,0.03)] border border-slate-50">
              <div className="mb-8">
                <div className="border-l-[3px] border-[#0052CC] pl-4">
                  <h2 className="text-[19px] font-extrabold text-[#0F172A] tracking-wider uppercase mb-1">
                    THÔNG TIN CÁ NHÂN
                  </h2>
                  <p className="text-[#64748B] text-[13px] font-medium">
                    Vui lòng nhập chính xác theo giấy tờ tùy thân
                  </p>
                </div>
              </div>
              ...
              <form onSubmit={handleRegister} className="space-y-5">
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#F8F9FA] text-[#0F172A] text-[15px] font-medium px-4 py-3.5 rounded-xl outline-none focus:ring-2 focus:ring-[#0052CC]/20 border border-transparent focus:border-[#0052CC]/20 transition-all placeholder:font-normal placeholder:text-[#94A3B8]"
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 bg-[#1E293B] hover:bg-[#0F172A] text-white py-4 rounded-xl font-bold text-[15px] transition-colors shadow-md disabled:opacity-60"
                  >
                    {loading ? (
                      "Đang xử lý..."
                    ) : (
      ...
      <footer className="bg-[#F8F9FA] py-10 w-full flex flex-col items-center border-t border-slate-200">
        <div className="text-[24px] font-extrabold tracking-tight mb-4">
          <span className="text-[#0052CC]">Dorm</span>
          <span className="text-[#0F172A]">Stay</span>
        </div>
        <div className="flex items-center gap-6 text-[13px] text-[#64748B] font-medium mb-3">
          <Link to="#" className="hover:text-[#0052CC] transition-colors">
            Điều khoản
          </Link>
          <Link to="#" className="hover:text-[#0052CC] transition-colors">
            Bảo mật
