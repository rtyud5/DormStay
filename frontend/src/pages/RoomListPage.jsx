               ...
               <div>
                  ...
                  <div className="flex gap-2 mb-4">
                     <input 
                        ...
                        onChange={(e) => setFilters({...filters, minPrice: parseInt(e.target.value) * 1000000 || 0})}
                        className="flex-1 bg-[#F1F5F9] text-[#0F172A] text-[13px] font-medium px-3 py-2 rounded-lg outline-none focus:ring-2 focus:ring-[#0052CC]/20 border border-transparent focus:border-[#0052CC]/20 transition-all"
                     />
                     <input 
                        type="number" 
                        placeholder="Max" 
                        value={filters.maxPrice / 1000000}
                        onChange={(e) => setFilters({...filters, maxPrice: parseInt(e.target.value) * 1000000 || 10000000})}
                        className="flex-1 bg-[#F1F5F9] text-[#0F172A] text-[13px] font-medium px-3 py-2 rounded-lg outline-none focus:ring-2 focus:ring-[#0052CC]/20 border border-transparent focus:border-[#0052CC]/20 transition-all"
                     />
                  </div>
                  ...
                  <div key={room.id} className="bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all group flex flex-col">
                     ...
                     <div className="p-6 flex flex-col flex-1">
                        ...
                        <div className="flex items-center gap-4 text-[13px] font-semibold text-[#475569] mb-4">
                           {console.log('Room type:', room.type, 'Capacity:', room.capacity) || (room.type !== 'PHONG_CHUNG' && (
